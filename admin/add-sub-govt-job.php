...
<head>
    ...
    <title>rozgharpk | Add Sub Govt Jobs</title>
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" name="category" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" name="GovtJobId" required>
                                                        <option value="">Select Govt Jobs </option>

                                                        <option value="">Sub Govt Jobs</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" value="" name="GovtJob" required>
                                                </div>
                                            </div>
