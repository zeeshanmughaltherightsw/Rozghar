...
<head>
    ...
    <title>rozgharpk | Edit Sub Blog</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Add Sub Blog</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>Add Sub Blog </b></h4>
                                <hr />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="form-horizontal" name="category" method="post">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Sub Blog</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Sub Blog Description</label>
                                                <div class="col-md-10">
