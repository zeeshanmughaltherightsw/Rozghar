...
<head>
    ...
    <!-- App title -->
    <title>rozgharpk | Add Govt Job Post</title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Add Govt job Post </h4>
                                <ol class="breadcrumb p-0 m-0">
                                    <li>
                                        <a href="#">Govt job Post </a>
                                    </li>
                                    <li>
                                        <a href="#">Add Govt job </a>
                                    </li>
                                    <li class="active">
                                        Add Govt job Post
                                    </li>
                                ...
                                <div class="">
                                    <form name="addpost" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" name="GovtJob" id="category" onChange="getSubCat(this.value);" required>
                                                <option value="">Select Govt Jobs </option>

                                                <option value="Govt Job">Govt Jobs</option>
                                        ...
                                        <div class="form-group m-b-20">
                                            ...
                                            <select class="form-control" name="SubGovtJob" id="subcategory" required>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="card-box">
                                                    ...
                                                    <input type="date" class="form-control" name="last_date" required></textarea>
                                                </div>
                                            </div>
                                        </div>
